...
class Mgard(CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant("mdr", description="enable multi-precision data refactoring support", default=False, when="@2024.11.16:")
    ...
    patch("hip-cub-configure.patch", when="@:2024.11.16")
    ...
    def cmake_args(self):
        ...
        if "+rocm" in spec:
            ...
            args.append(self.define_from_variant("MGARD_ENABLE_MDR", "mdr"))
        return args
