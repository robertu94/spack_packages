...
class Sz3(Sz3Builtin):
    ...
    version("3.4.0", commit="dd7ac7c802f26e08040dc7ee243a5f25f2d205df")
    ...
    depends_on("eigen", when="@3.4.0:", type=("build", "link"))
    depends_on("llvm-openmp", type=("build", "link"), when="%apple-clang")
